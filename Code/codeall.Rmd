...
```{r, fig.align = "center",tidy=TRUE,message=FALSE,echo=T}
if (doDataCleaning) {
    ###################################################################################################################
  ###################################################################################################################
...
\newpage
**taag weekly**
```{r , echo=T, fig.align = "center",tidy=TRUE}
...
```{r, fig.align = "center",tidy=TRUE,include=T}
...
```{r, fig.align = "center",tidy=TRUE,message=FALSE, include=T}
...
```{r, fig.align = "center",tidy=TRUE,message=FALSE,include=T,results='asis',out.extra='FloatBarrier'}
...
\newpage
**TAAG**
```{r, fig.align = "center",tidy=TRUE,message=FALSE,results='asis',include = T}
...
```{r, fig.align = "center",tidy=TRUE,message=FALSE,results='asis',echo=T}
#Taag weekly 
#model = sparse var
#penalty = hlag
set.seed(1)
...
```{r, fig.align = "center",tidy=TRUE,message=FALSE,results='asis',echo=T,out.extra='FloatBarrier'}
